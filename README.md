...
I would say its a program that helps you organize code and then puts it normally for you.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

I like the mixins. Functions are fun. I think escaping looks a bit confusing too me I prefer the normal way.

3. How would you explain the concept of a variable to someone new to programming?

A varible is like making a mold for clay sculptures.

4. What is the purpose of using functions in code?

To make things easier to change and to keep code DRY.

5. What is a JSON data?
those are the types like string numbers arrays booleans objects
